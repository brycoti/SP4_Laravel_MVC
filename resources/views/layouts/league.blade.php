            ...
            <h1 class="text-3xl font-semibold">Football League</h1>
                ...
                <nav class="space-x-4">
                    ...
                    <a href="{{route('matches.index')}}" class="inline-flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-300 text-center">
                     ...
                     <a href="{{route('matches.create')}}" class="inline-flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-300 text-center">
                        Create Match
                    </a>
                </nav>
            </div>
